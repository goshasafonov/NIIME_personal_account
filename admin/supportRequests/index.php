...
$contentJsScript = '<script src="' . $host . '/admin/supportRequests/content.js" type="text/javascript"></script>';

$contentCss = ''
	.'<link rel="stylesheet" href="' . $host . '/admin/supportRequests/content.css" type="text/css">'
