...
$page = "";
$titlePage = $titlePage . " | Технологии";
...
//fouter
$contentJsScript = '<script src="' . $host . '/admin/controlDataBase/technology/content.js" type="text/javascript"></script>';
$contentCss = '<link rel="stylesheet" href="' . $host . '/admin/controlDataBase/technology/content.css" type="text/css">';
